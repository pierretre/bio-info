...
public class Utils {
	...
	public static String nucleotidesToAminoAcids(String nuclSeq) {
		String aaSeq = "";
		for(int i=0; i+3 <= nuclSeq.length(); i+=3)
			aaSeq += codon2aa(nuclSeq.substring(i, i + 3));
		return aaSeq;
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("\nNewick : \n" + clusterHemoglobinProteins.getNewick());
			System.out.println("\nNewick Aligned : \n" + clusterHemoglobinProteins.getNewickAligned());
			System.out.println("\nNewick Aligned and Distance proportionnal : \n" + clusterHemoglobinProteins.getNewickAlignedDistance());
